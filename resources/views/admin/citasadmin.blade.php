...
<body>
    ...
    <script>
        // sistema-pagos.js - Sistema completo de gestión de pagos
        // Incluir este script en tu vista admin.citasadmin
        ...
        `;
                    ...
                    function validatePaymentForm() {
                        ...
                        if (metodo === 'efectivo') {
                            ...
                            const total = totalElement ? parseFloat(totalElement.textContent.replace(', '
                                    ')) : 0;
