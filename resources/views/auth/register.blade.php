...
<body class="wave-animation">
    <div class="main-container min-h-screen flex flex-col justify-start sm:justify-center items-center p-4 relative overflow-hidden">
        ...
        <div class="form-container w-full max-w-lg relative z-10">
            ...
            <div class="logo-container text-center mb-6 sm:mb-8">
                <div class="logo-icon mx-auto w-16 h-16 sm:w-20 sm:h-20 bg-white bg-opacity-20 rounded-full flex items-center justify-center mb-3 sm:mb-4 backdrop-blur-sm border border-white border-opacity-30">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                <button type="button" class="password-toggle text-gray-400 hover:text-blue-500" onclick="togglePassword('password', 'eyeIcon1')">
                                    <svg id="eyeIcon1" class="h-4 w-4 sm:h-5 sm:w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                <button type="button" class="password-toggle text-gray-400 hover:text-blue-500" onclick="togglePassword('password_confirmation', 'eyeIcon2')">
                                    <svg id="eyeIcon2" class="h-4 w-4 sm:h-5 sm:w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                    </svg>
                                </button>
