                                        ...
                                        <div class="header-content">
                                            <div class="welcome-section">
                                                ...
                                                <div class="welcome-stats">
                                                    ...
                                                    <div class="welcome-stat">
                                                        <span
                                                            class="number">{{ $stats['citas_finalizadas'] ?? 0 }}</span>
                                                        ...
                                                        @foreach ($citas_hoy as $cita)
                                                            <div class="appointment-card">
                                                                <h3>
                                                                    ...
                                                                    <span
                                                                        class="status-badge status-{{ $cita->estado }}">
                                                                        {{ ucfirst($cita->estado) }}
                                                                    </span>
                                                                </h3>
                                                                <p>
                                                                ...
                                                                <div style="margin: 10px 0;">
                                                                    @foreach ($cita->servicios as $servicio)
                                                                        <span
                                                                            class="service-tag">{{ $servicio->nombre }}
                                                                ...
                                                                <div class="appointment-actions">
                                                                    ...
                                                                    @elseif ($cita->estado == 'en_proceso')
                                                                        <button
                                                                            onclick="mostrarModalFinalizar({{ $cita->id }})"
                                                                            class="btn btn-sm btn-success">
                                                                            <i class="fas fa-check"></i> Finalizar
                                                                        </button>
                                                                        <button
                                                                            onclick="mostrarModalObservaciones({{ $cita->id }})"
                                                        ...
                                                        @foreach ($historial as $cita)
                                                            <div class="service-history-item">
                                                                ...
                                                                <div class="service-details">
                                                                    <h4>{{ $cita->usuario?->nombre ?? 'Cliente no especificado' }}
                                                                    </h4>
                                                                    ...
                                                                    @if ($cita->observaciones_empleado)
                                                                        <p><i class="fas fa-comment"></i>
                                                                            {{ Str::limit($cita->observaciones_empleado, 50) }}
                                                                        </p>
                                                                    @endif
                                                                </div>
